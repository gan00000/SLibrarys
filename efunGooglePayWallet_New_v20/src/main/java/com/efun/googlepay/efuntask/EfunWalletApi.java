...
//		List<NameValuePair> params = new ArrayList<NameValuePair>();
		...
		EfunLogUtil.logD("orderBean hashCode:" + orderBean.hashCode() + ",userId:" + userId + ",creditId:" + creditId + ",sku:" + goodsId + ",moneyType:" + 
		...
		if (EfunStringUtil.isNotEmpty(userId)&& EfunStringUtil.isNotEmpty(creditId) && EfunStringUtil.isNotEmpty(goodsId) 
			...
			String localIpAddress = EfunLocalUtil.getLocalIpAddress(context);
