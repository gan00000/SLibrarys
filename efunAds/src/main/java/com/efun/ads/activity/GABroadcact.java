...
public class GABroadcact extends BroadcastReceiver {
	...
	public void onReceive(Context ctx, Intent intent) {
		...
		try {
			...
			if (EfunStringUtil.isNotEmpty(galistener) && galistener.startsWith("com.")) {
				
				Class<GAListener> clazz = (Class<com.efun.ads.callback.GAListener>) Class.forName(galistener);
				if (clazz != null) {
