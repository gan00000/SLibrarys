...
public class GoogleSignIn implements GoogleApiClient.OnConnectionFailedListener,GoogleApiClient.ConnectionCallbacks {
	...
	public GoogleSignIn(FragmentActivity fragmentActivity) {
		...
		if (fragmentActivity == null) {
			Log.e(TAG,"GoogleSignIn fragmentActivity must not null");
			return;
		}
		...
		// options above.
		mGoogleApiClient = new GoogleApiClient.Builder(fragmentActivity).enableAutoManage(fragmentActivity, this).addApi(Auth.GOOGLE_SIGN_IN_API, gso).build();*/
	}
...
//		signIn();
	...
	private ProgressDialog initDialog() {  //初始化loading窗
		mConnectionProgressDialog = new ProgressDialog(fragmentActivity);
   ...
   // [END revokeAccess]
	...
	public void share(String text,String url){
		// Launch the Google+ share dialog with attribution to your app.
	      Intent shareIntent = new PlusShare.Builder(fragmentActivity)
	          .setType("text/plain")
	          .setText(text)
	          .setContentUrl(Uri.parse(url))
	          .getIntent();
	      fragmentActivity.startActivityForResult(shareIntent, GOOGLE_SHARE_CODE);
	}
	...
	private void showErrorDialog(int errorCode) {
		...
		dialogFragment.setmGoogleSignIn(this);
	...
	public static class ErrorDialogFragment extends DialogFragment {
		...
		public void setmGoogleSignIn(GoogleSignIn mGoogleSignIn) {
			this.mGoogleSignIn = mGoogleSignIn;
		}
		...
		public void onDismiss(DialogInterface dialog) {
			if (mGoogleSignIn != null) {
				mGoogleSignIn.onDialogDismissed();
			}
		}
	}
}
