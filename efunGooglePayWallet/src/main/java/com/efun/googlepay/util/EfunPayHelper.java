...
//		EfunDatabase.saveSimpleInfo(context, EfunDatabase.EFUN_FILE, "EFUN_LOGIN_SIGN");
		return EfunDatabase.getSimpleString(context, EfunDatabase.EFUN_FILE, "EFUN_LOGIN_SIGN");
	}
}
