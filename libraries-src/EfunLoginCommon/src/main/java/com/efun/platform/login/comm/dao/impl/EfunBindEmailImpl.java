 ...
 * <p>Description: efun账号绑定某个邮箱功能</p>
 * <p>Company: EFun</p> 
 * @author GanYuanrong
 * @date 2013年12月7日
 */
public class EfunBindEmailImpl extends EfunBaseLoginDao {
	...
	public String efunRequestServer() throws EfunException {
		...
		Map<String, String> nameValuePairs = EfunParamsBuilder.buildBindEmail(parameters);
		if (nameValuePairs == null) {
			return null;
		}
		return EfunJSONUtil.efunTransformToJSONStr(doRequest(DomainSuffix.URL_BIND_EMAIL, nameValuePairs));
	}
}
