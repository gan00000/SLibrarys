 ...
 * @date 2013年12月7日
 */
public class EfunSwitchImpl extends EfunBaseLoginDao {
...
//		}
		Map<String, String> nameValuePairs = EfunParamsBuilder.buildSwitch(parameters);
		if (nameValuePairs == null) {
			return null;
		}
		return EfunJSONUtil.efunTransformToJSONStr(doRequest(DomainSuffix.URL_SWITCH_EFUN, nameValuePairs));
	}
