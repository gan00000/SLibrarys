...
/**
 * <p>Title: EfunChagePwd</p>
 * <p>Description: </p>
 * <p>Company: EFun</p> 
 * @author GanYuanrong
 * @date 2013年12月7日
 */
public class EfunChagePwdImpl extends EfunBaseLoginDao {
	...
	public String efunRequestServer() throws EfunException {
		...
		Map<String, String> nameValuePairs = EfunParamsBuilder.buildChagePwd(parameters);
		if (nameValuePairs == null) {
			return null;
		}
		return EfunJSONUtil.efunTransformToJSONStr(doRequest(DomainSuffix.URL_CHANGE_PWD, nameValuePairs));
	}
}
