...
public class EfunLoginHelper {
	...
	public static String getBusinessIds(Context context) {
		return SPUtil.getSimpleString(context, SPUtil.EFUN_FILE, SPUtil.EFUN_APP_BUSINESS_IDS);
	}
	...
	public static void saveLoginReponse(Context context,String reponse){
		SPUtil.saveSimpleInfo(context, SPUtil.EFUN_FILE, LOGIN_REPONSE_KEY, reponse);
	}
	
	public static String fetchLoginReponse(Context context){
		return SPUtil.getSimpleString(context, SPUtil.EFUN_FILE, LOGIN_REPONSE_KEY);
	}
