...
//
//	public static Map<String, String> buildLogin(LoginBaseRequest login) {
//
...
//
//
//	public static Map<String, String> buildRegister(LoginBaseRequest register) {
//		Long currentTime = System.currentTimeMillis();
//		Map<String, String> postParams = new HashMap<String, String>();
...
//	}
//
//	public static Map<String, String> buildChagePwd(LoginBaseRequest parameters){
//
//		Long currentTime = System.currentTimeMillis();
//		Map<String, String> postParams = new HashMap<String, String>();
...
//	* @return
//	*/
//	public static Map<String, String> buildThirdPlat2(LoginBaseRequest parameters){
//
//		Long currentTime = System.currentTimeMillis();
//		Map<String, String> postParams = new HashMap<String, String>();
//		postParams.put(HttpParamsKey.timestamp, currentTime+"");
...
//	 * @return
//	 */
//	public static Map<String, String> buildMacLogin(LoginBaseRequest parameters){
//
//		Long currentTime = System.currentTimeMillis();
//		Map<String, String> postParams = new HashMap<String, String>();
//		postParams.put(HttpParamsKey.timestamp, currentTime+"");
...
//
//
//	private static void addCommonParams(LoginBaseRequest parameters, Map<String, String> map) {
