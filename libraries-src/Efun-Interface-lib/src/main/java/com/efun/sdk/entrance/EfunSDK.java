...
import com.efun.sdk.callback.EfunLocationRequestCallback;
...
import com.efun.sdk.entrance.entity.EfunMapEntity;
import com.efun.sdk.entrance.entity.EfunNoteEntity;
import com.efun.sdk.entrance.entity.EfunNotificationEntity;
...
public abstract class EfunSDK {
	...
	public void efunSetLanguage(Context context, String language) {
		...
		EfunDatabase.saveSimpleInfo(context, EfunDatabase.EFUN_FILE, EFUN_SDK_LANGUAGE, language);
	}
	...
	public String fetchLoginProfile(Context context) {
		return EfunLoginHelper.fetchLoginReponse(context);
	}

	public void fetchUnitePageUrls(Context context, OnEfunSwitchCallBack callBack) {
		EfunSwitchHelper.switchInitByTypeNames(context, "application", callBack);
	}
	
	public void efunShowIapInduceView(Context context, EfunInduceEntity entity) {
		
	}
	
	public void efunShowMap(Context context, EfunMapEntity entity) {
		
	}

	public void efunFetchMapMarkers(Context context, EfunMapEntity entity) {
		
	}
	
	public Bitmap efunScreenshot(Activity act, View view){
		return null;
	} 
	
	public void efunWriteToSavedPhotosAlbum(Context context, Bitmap bitmap){}
	...
	public void efunLocationRequest(Context context, EfunLocationRequestCallback callback) {
