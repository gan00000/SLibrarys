...
import com.starpy.base.constant.InviteType;
...
import com.starpy.base.task.command.impl.EfunDynamicUrlCmd;
import com.starpy.base.task.command.impl.EfunReadFileConfigCmd;
...
public class EfunDynamicUrl {
	...
	public static String getDynamicPlatformVersionContent(Context context) {
		return SPUtil.getSimpleString(context, SPUtil.EFUN_FILE, SPUtil.EFUN_APP_PLATFORM_DYNAMIC_VERSION_CONTENT);
	}

	public static String getDynamicGameVersionContent(Context context) {
		return SPUtil.getSimpleString(context, SPUtil.EFUN_FILE, SPUtil.EFUN_GAME_DYNAMIC_VERSION_CONTENT);
	}
