...
public class Native2JS {
	...
	public String getAndroidId(){
		return ApkInfoUtil.getLocalAndroidId(context);
	}
	
	@JavascriptInterface
	public String getImei(){
		return ApkInfoUtil.getLocalImeiAddress(context);
	}
	...
	public String getMac(){
		return ApkInfoUtil.getLocalMacAddress(context);
	}
	...
	public String getUserName(){
		return SPUtil.getSimpleString(context, SPUtil.EFUN_FILE, SPUtil.EFUN_LOGIN_USERNAME);
	}
	@JavascriptInterface
	public String getPassword(){
		return SPUtil.getSimpleString(context, SPUtil.EFUN_FILE, SPUtil.EFUN_LOGIN_PASSWORD);
	}
...
//	deviceInfo：{"systemVersion":"4.3.1","mac":"d4:6e:5c:41:d1:2f","deviceType":"HUAWEI G700-T00","imei":"860457020317674","ip":"172.16.80.159"}
	...
	public String getDeviceInfo(){
		...
		try {
			...
			jsonObject.put("mac", ApkInfoUtil.getLocalMacAddress(context));
			jsonObject.put("deviceType", ApkInfoUtil.getDeviceType());
			jsonObject.put("imei", ApkInfoUtil.getLocalImeiAddress(context));
			jsonObject.put("ip", ApkInfoUtil.getLocalIpAddress(context));
			jsonObject.put("androidid", ApkInfoUtil.getLocalAndroidId(context));
