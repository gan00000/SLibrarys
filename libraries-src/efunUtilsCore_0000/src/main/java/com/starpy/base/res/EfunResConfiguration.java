package com.starpy.base.res;

import android.content.Context;
import android.text.TextUtils;
import android.util.Log;

import com.starpy.base.cipher.EfunCipher;
...
public class EfunResConfiguration {
	...
	public static void clearLoginMsg(Context context) {
		...
		SPUtil.saveSimpleInfo(context, SPUtil.EFUN_FILE, SPUtil.EFUN_LOGIN_SIGN, "");// 广告启动（每次启动游戏）清除掉sign
		SPUtil.saveSimpleInfo(context, SPUtil.EFUN_FILE, SPUtil.EFUN_LOGIN_TIMESTAMP, "");
		SPUtil.saveSimpleInfo(context, SPUtil.EFUN_FILE, SPUtil.EFUN_LOGIN_SERVER_RETURN_DATA, "");
		SPUtil.saveSimpleInfo(context, SPUtil.EFUN_FILE, SPUtil.EFUN_LOGIN_USER_ID, "");
	}
	...
	public static String getSDKLoginReturnData(Context context) {
		...
		return SPUtil.getSimpleString(context, SPUtil.EFUN_FILE, SPUtil.EFUN_LOGIN_SERVER_RETURN_DATA);
	}
	...
	public static void setLoginSign(Context context,String loginSign) {
		SPUtil.saveSimpleInfo(context, SPUtil.EFUN_FILE, SPUtil.EFUN_LOGIN_SIGN, loginSign);
	...
	public static void setRegion(Context context,String region){
		...
		SPUtil.saveSimpleInfo(context, SPUtil.EFUN_FILE, SPUtil.EFUN_GAME_REGION, region);
	}
	
	public static String getRegion(Context context){
		if (TextUtils.isEmpty(region)) {
			region = SPUtil.getSimpleString(context, SPUtil.EFUN_FILE, SPUtil.EFUN_GAME_REGION);
		}
		return region;
	}
	...
	public static String getSDKLanguage(Context context) {
		String language = SPUtil.getSimpleString(context, SPUtil.EFUN_FILE, SPUtil.EFUN_SDK_LANGUAGE);
	...
	public static String getSDKLoginSign(Context context){
		loginSign = SPUtil.getSimpleString(context, SPUtil.EFUN_FILE, SPUtil.EFUN_LOGIN_SIGN);
		return loginSign;
	}
	
	public static String getSDKLoginTimestamp(Context context){
		loginTimestamp = SPUtil.getSimpleString(context, SPUtil.EFUN_FILE, SPUtil.EFUN_LOGIN_TIMESTAMP);
		return loginTimestamp;
	}
	
	public static String getCurrentEfunUserId(Context context){
		return SPUtil.getSimpleString(context, SPUtil.EFUN_FILE, SPUtil.EFUN_LOGIN_USER_ID);
	}
