...
public class HttpFileUploadRequest {
    ...
    public static String uploadFile(Map<String, String> params, File uploadFile, String newFileName, String urlStr){
        ...
        try {
            ...
            byte[] endInfo = ("\r\n--" + BOUNDARY + "--\r\n").getBytes("UTF-8");
            com.efun.core.tools.EfunLogUtil.logD("HttpFileUploadRequest", sb.toString());
            ...
            if (conn.getResponseCode() == 200) {
                com.efun.core.tools.EfunLogUtil.logD("上传成功");
                /* 取得Response内容 */
            ...
            try {
                ...
                if(conn != null) {
                    conn.disconnect();
                    com.efun.core.tools.EfunLogUtil.logD("HttpFileUploadRequest", "urlConnection.disconnect()");
                }
