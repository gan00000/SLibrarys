...
/*		if (startId > 1) {
	...
	protected void resetClient() {
		//SharedPreferences account = this.getSharedPreferences(PushParams.DEFAULT_PRE_NAME, Context.MODE_PRIVATE);
		String serverIp = SPUtil.getSimpleString(this, StarPyUtil.STAR_PY_SP_FILE, PushConstant.PUSH_SERVER_IP);//account.getString(PushParams.SERVER_IP, "");
		String serverPort = SPUtil.getSimpleString(this, StarPyUtil.STAR_PY_SP_FILE, PushConstant.PUSH_SERVER_PORT);// account.getString(PushParams.SERVER_PORT, "");
