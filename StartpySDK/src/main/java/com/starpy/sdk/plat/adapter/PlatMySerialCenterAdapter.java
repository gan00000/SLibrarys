...
public class PlatMySerialCenterAdapter extends RecyclerView.Adapter {
    ...
    public PlatMySerialCenterAdapter(Activity activity) {
    ...
    private class GiftCenterHolder extends RecyclerView.ViewHolder{
        ...
        public GiftCenterHolder(View contentView) {
            ...
            itemSimpleDraweeView.setOnClickListener(new View.OnClickListener() {
                @Override
